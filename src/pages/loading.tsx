export default function LoadingPage() {
   return (
      <>
         <div className="w-fit h-screen z-40 flex flex-col mx-auto px-auto justify-center items-center">
            ...
            <h1 className="text-xl font-normal font-navbar-header"> The Computer hub of MUJ! </h1>
         </div>
      </>
   )
}